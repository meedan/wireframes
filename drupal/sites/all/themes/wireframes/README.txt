...
- Download Basic from http://drupal.org/project/wireframes
...
- if you want to change the name of the theme from 'wireframes' to another name like 'mytheme',
follow these steps (to do BEFORE enabling the theme) :

	- rename the theme folder to 'mytheme'
	- rename wireframes.info to mytheme.info
	- Edit wireframes.info and change the name, description, projet (can be deleted)
	- In wireframes.info replace [wireframes_block_editing] and [wireframes_rebuild_registry]
	  by [mytheme_block_editing] and [mytheme_rebuild_registry]
	- In template.php change each iteration of 'wireframes' to 'mytheme'
	- In theme-settings.php change each iteration of 'wireframes' to 'mytheme'
...
- wireframes.info => provide informations about the theme, like regions, css, settings, js ...
...
This is how the page template is buit in wireframes, and it works in fluid and fixed layout.
...
Once you start using wireframes, you will massively change it until a point where it has nothing
to do with wireframes anymore. Unlike ZEN, wireframes is not intended to be use as a base theme for a 
...
If you didn't rename your theme, but you don't want to be notified when wireframes has a new version
by the update module, simply delete "project = "wireframes" in wireframes.info
...
http://drupal.org/project/issues/wireframes
